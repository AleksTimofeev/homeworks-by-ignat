...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): any => { // need to fix any
    ...
    else if (filter === 'high') return affairs.filter((a: AffairType) => a.priority === filter)
    else if (filter === 'middle') return affairs.filter((a: AffairType) => a.priority === filter)
    else if (filter === 'low') return affairs.filter((a: AffairType) => a.priority === filter)// need to fix
}
